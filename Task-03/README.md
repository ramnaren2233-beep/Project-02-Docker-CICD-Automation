...
1. `01-dockerignore.png`
2. `02-secure-dockerfile-final.png`
3. `03-secure-image-build.png`
4. `04-docker-image.png`
5. `05-container-running.png`
6. `06-non-root-user.png`
7. `07-browser-app.png`
8. `08-security-scan.png`
